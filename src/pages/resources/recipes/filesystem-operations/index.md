...
Make sure you understand how [Manifest permissions](../../../plugins/index.md) work before implementing file operations in your plugin.

The detailed [`PermissionsDefinition` reference](../../../plugins/index.md) explains all available permission options and their security implications.
...
In the example above, we use the `domains.userDesktop` token to get the user's Desktop folder. You can use other domains tokens, such as `domains.userDocuments`, `domains.userDownloads`, etc. Check the [Domain Tokens](../../../uxp-api/index.md) reference for the full list.
...
- [**Session tokens**](../../../uxp-api/index.md): Last until the plugin is unloaded or the application closes
- [**Persistent tokens**](../../../uxp-api/index.md): Survive across sessions until the plugin is uninstalled
...
Store tokens in [`localStorage`](../../../uxp-api/index.md) or your plugin's data folder so they persist between plugin sessions. Always handle cases where tokens become invalid (e.g., if the user deletes or moves the file).

### `LocalFileSystem` API Reference

For complete API documentation, see:

- [FileSystemProvider](../../../uxp-api/index.md): main interface for file system operations.
- [Entry](../../../uxp-api/index.md): base class for files and folders.
- [File](../../../uxp-api/index.md): file-specific operations.
- [Folder](../../../uxp-api/index.md): folder-specific operations.
- [EntryMetadata](../../../uxp-api/index.md): file and folder metadata.
- [Path](../../../uxp-api/index.md): path manipulation utilities.
...
- [`fs` module](../../../uxp-api/index.md): complete file system API reference.
- [`path`](../../../uxp-api/index.md): path manipulation utilities.
...
- [`fs` module](../../../uxp-api/index.md): complete file system API reference.
- [Path](../../../uxp-api/index.md): path manipulation utilities.
- [LocalStorage](../../../uxp-api/index.md): persistent data storage for tokens.
- [Manifest Permissions](../../../plugins/index.md): overview of all permissions.
- [Local File System Permission](../../../plugins/index.md): detailed permission documentation.
