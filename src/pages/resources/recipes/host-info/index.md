...
| :----------------------------------------------------------------------------- | :----------------------------- | :------------------------------------------------------------------------------------ |
| [`host`](../../../uxp-api/index.md) | Application and UI information | `name`, `version`, `uiLocale`                                                         |
| [`versions`](../../../uxp-api/index.md)   | UXP runtime and plugin version | `uxp`, `plugin`                                                                       |
| [`os`](../../../uxp-api/index.md)                         | Operating system information   | `platform()`, `release()`, `arch()`, `cpus()`, `totalmem()`, `freemem()`, `homedir()` |
...
=== Host Environment ===
OS: darwin 24.6.0
Application: mediaencoder v26.5.0
...
- [`host` module](../../../uxp-api/index.md): application and UI information.
- [`versions` module](../../../uxp-api/index.md): UXP and plugin version information.
- [`os` module](../../../uxp-api/index.md): operating system information.
