...
UXP provides clipboard APIs that let your plugin **read from** and **write to** the system clipboard—enabling users to copy, paste, and share content between your plugin and other applications. This guide covers how to use the [`Clipboard` API](../../../uxp-api/index.md), declare the necessary permissions, and handle common use cases.
...
By default, UXP plugins can't access the system clipboard; this protects users from unwanted data access. If your plugin needs to read or write clipboard content, **you must declare** the right [clipboard permission](../../../plugins/index.md) in your `manifest.json`.
...
// Example usage
copyToClipboard("Welcome to UXP for Media Encoder!");
```
...
- [`Clipboard`](../../../uxp-api/index.md) API Reference.
