...
- [HTMLDialogElement](../../../uxp-api/index.md): dialog-specific properties and methods.
- [HTML Elements](../../../uxp-api/index.md): complete list of supported HTML elements.
- [Spectrum Web Components](../../../uxp-api/index.md): Adobe's UI component library.
