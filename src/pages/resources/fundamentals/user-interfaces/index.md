...
Every UXP plugin with a visual component needs a user interface. Whether you're building a simple dialog or a complex panel, UXP gives you multiple ways to create UI that looks and feels like a native part of Media Encoder.
...
Each technology has its strengths and you can mix and match them in the same plugin—although **we recommend using Spectrum Web Components** going forward for the most complete feature set and future support. Please read the [Spectrum UXP Reference](../../../uxp-api/index.md) for more details.
...
While UXP supports modern web technologies, it's not a full browser environment. Not all HTML elements, CSS properties, or JavaScript APIs available in browsers will work in UXP. Check the [UXP API reference](../../../uxp-api/index.md) for a list of unsupported HTML elements and attributes.

### Spectrum UXP Widgets

Spectrum UXP Widgets are built directly into the UXP platform. They provide ready-to-use, Adobe-styled components that automatically match Media Encoder's look and feel, including dark and light theme support.
...
| Best for                                                                                                      | Trade-offs                                                                                                                                                  |
| ------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Quick prototyping**, getting started with UXP, or when you want Media Encoder's native look without extra setup. | **Limited number of components** available. \<br/\>**You can't customize their behavior** beyond the provided API or easily inspect their internal structure. |
...
Best UX practices, as well as adherence to the Adobe Brand Guidelines, [will be enforced](../../../plugins/index.md) during the approval process.

## Working with JavaScript Frameworks

While vanilla JavaScript, HTML, and CSS are sufficient for many plugins, complex applications can benefit from modern JavaScript frameworks. UXP plugins [work well](../../../plugins/index.md) with popular frameworks like **React**, **Vue**, and **Svelte**.
...
If you're already familiar with React or plan to build a complex plugin, check out the [Using Spectrum with React](../../../uxp-api/index.md) guide for tips on integrating Spectrum components with React. The most popular approach is to use [React Wrappers for Spectrum Web Components](https://opensource.adobe.com/spectrum-web-components/using-swc-react/).

## Reference Documentation

Ready to start building? Explore the complete documentation for each UI approach.

- **[Spectrum Web Components](../../../uxp-api/index.md)**: full SWC component library and usage examples.
- **[Spectrum UXP Widgets](../../../uxp-api/index.md)**: built-in widget reference and API documentation.
- **[HTML Elements](../../../uxp-api/index.md)**: supported HTML elements in UXP.
- **[HTML Tags Reference](../../../uxp-api/index.md)**: complete HTML tag documentation.
- **[Using Spectrum with React](../../../uxp-api/index.md)**: integration guide for React developers (see also the [Working with Bundlers](../../../plugins/index.md) section of the UXP Developer Tool documentation).
