...
UXP supports a focused subset of web platform features rather than everything a browser offers. When in doubt, check the [UXP API reference](https://developer-stage.adobe.com/uxp/uxp-api/?aio_external=true) for the exact elements, styles, and modules that are supported, instead of assuming a browser API exists.
